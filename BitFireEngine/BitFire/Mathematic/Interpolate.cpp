...
float Interpolate::Liniar(const float yMinimum, const float yMaximum, const float xMinimum, const float xMaximum, float xValue)
{
    // Cap Value
...
float Interpolate::LiniarClampBetweenZeroAndOne(const float minimum, const float maximum, const float value)
{
    return Interpolate::Liniar(0, 1, minimum, maximum, value);
}

unsigned int Interpolate::LiniarClampAsRGBColor(const float minimum, const float maximum, const float value)
{
