...
unsigned BF::ADAM7::unfilterScanline(unsigned char* recon, const unsigned char* scanline, const unsigned char* precon, size_t bytewidth, unsigned char filterType, size_t length)
{
    /*
...
unsigned char BF::ADAM7::readBitFromReversedStream(size_t* bitpointer, const unsigned char* bitstream)
{
...
void BF::ADAM7::setBitOfReversedStream(size_t* bitpointer, unsigned char* bitstream, unsigned char bit)
{
