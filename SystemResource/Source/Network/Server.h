...
namespace BF
{
    class Server
    {
        ...
        SocketActionResult SendMessageToAll(const unsigned char* data, const size_t dataSize);
        SocketActionResult SendMessageToClient(const ClientID clientID, const unsigned char* data, const size_t dataSize);
